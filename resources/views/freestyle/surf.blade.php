...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid p-0 banner d-flex align-items-center justify-content-center" style="background-image: url('{{ asset('images/surfing/s4.jpeg') }}'); height: 510px; object-fit: cover;">
            <div class="container">
                <h1 class="display-3 text-center white"> Big Wave Surfing</h1>
            </div>
        </div>
        ...
        <div class="container" style="padding: 95px;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="mt-4">What do the best and most extreme surf spots in the world have in common?</h1>
                    ...
                    <p>
                        ...
                        <br>
                        <br>
                        <img class="img-fluid rounded" src="{{ asset('images/surfing/s11.jpeg') }}" style="width: 900px; object-fit: cover;" alt="" />
                    ...
                    <hr />
                    <h2>Heavy, Big, Fast, and Deadly</h2>
                    <hr>
                    ...
                    <hr />
                    <h2>Praia do Norte | Nazaré, Portugal</h2>
                    <hr>
                    <img class="img-fluid rounded" src="{{ asset('images/surfing/s5.jpeg') }}" style="width: 900px; object-fit: cover;" alt="" />
                    <hr>
                    <p>
                    ...
                    <hr>
                    <h2>Jaws/Peahi | Maui, Hawaii</h2>
                    <hr>
                    <img class="img-fluid rounded" src="{{ asset('images/surfing/s6.jpeg') }}" style="width: 900px; object-fit: cover;" alt="" />
                    <hr>
                    <p>
                        ...
                        <br>
                        <br>
                        The submerged reef break produces a barreling right-hand and occasionally delivers a few rideable yet dangerous left-handers.
                       
                    </p>
                    <hr>
                    <h2>Teahupoo | Tahiti, French Polynesia
                    </h2>
                    <hr>
                    <img class="img-fluid rounded" src="{{ asset('images/surfing/s7.jpeg') }}" style="width: 900px; object-fit: cover;" alt="" />
                    <hr>
                    <p>
                    ...
                    <hr>
                    <h2>Shipstern Bluff | Tasmania, Australia
                    </h2>
                    <hr>
                    <img class="img-fluid rounded" src="{{ asset('images/surfing/s8.jpeg') }}" style="width: 900px; object-fit: cover;" alt="" />
                    <hr>
                    <p>
                        ...
                        <br>
                        <br>
                        Tasmania's most fearful surf spot can only be accessed by either a 30-kilometer jet ski or a boat ride or a two-hour hike through the Tasman National Park.
                    </p>
                  
                    <hr>
                    <h2>Mavericks | Half Moon Bay, California
                    </h2>
                    <hr>
                    <img class="img-fluid rounded" src="{{ asset('images/surfing/s9.jpeg') }}" style="width: 900px; object-fit: cover;" alt="" />
                    <hr>
                    <p>
                    ...
                    <hr>
                    <h2>Belharra | La Côte Basque, France
                    </h2>
                    <hr>
                    <img class="img-fluid rounded" src="{{ asset('images/surfing/s10.jpeg') }}" style="width: 900px; object-fit: cover;" alt="" />
                    <hr>
                    <p>

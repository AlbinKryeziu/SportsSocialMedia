                                ...
                                <div class="central-meta item">
                                    <div class="user-post">
                                        ...
                                        <span style="padding: 10px;">
                                            <td><i class="fa fa-eye-slash hiddePost" data-postId="{{$post->id}}" aria-hidden="true" style="float: right; padding-right: 10px;"></i></td>
                                        </span>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <span class="views" data-toggle="tooltip" title="views">
                                                                @if($post->like->where('user_id',auth()->user()->id)->count() )
                                                                <form class="" method="POST">
                                                                    <a href="{{ url('dislike/post/'.$post->id) }}"><i class="fa fa-thumbs-up" aria-hidden="true" style="color: #088dcd;"></i></a>
                                                                </form>
                                                                @else
                                                                <form class="" method="POST">
                                ...
                                <aside class="sidebar static">
                                    <div class="widget">
                                        ...
                                        <ul class="followers">
                                            ...
                                            <li>
                                                <figure>
                                                    <a href="{{ url('friends/profile/'.$user->id) }}"><img src="{{ asset('store/'.$user->profilePath) }}" alt="" style="height: 40px; width: 40px; object-fit: cover;" /></a>
                                                </figure>

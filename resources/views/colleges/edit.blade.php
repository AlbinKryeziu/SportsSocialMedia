...
<body>
    ...
    <div class="container-fluid p-0 banner d-flex align-items-center justify-content-center" style="background-image: url('{{ asset('images/college16.jpeg') }}'); height:500px;">
        <div class="container">
            <h1 class="display-3 text-center white">Edit {{ $college->name }}</h1>
        </div>
    </div>
    <form method="POST" action="{{ url('/colleges/update/'.$college->id) }}"  enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-md-12 p-4">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control input-md" name="name" value="{{ $college->name }}" />
                    </div>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control input-md" name="address" value="{{ $college->address }}" />
                    </div>
                    @error('address')
                    <div class="error" style="color: red;">{{ $message }}</div>
                    @enderror
              ...
              @endif
                    ...
                    <div>
                        <input type="file" id="avatar" name="avatar"  value="{{ $college->profilePath }}"/>
                    </div>
                    @error('avatar')
                    <div class="error" style="color: red;">{{ $message }}</div>
                    @enderror
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="services"  value="">{{ $college->services }}</textarea>
                    </div>
                    @error('services')
                    <div class="error" style="color: red;">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description">{{ $college->services }}</textarea>
                    @error('description')
                    <div class="error" style="color: red;">{{ $message }}</div>
                    @enderror
                    </div>
